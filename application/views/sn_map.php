...
<div class="map" id="map" style="height:500px;">
    <div class="map__image" style="height:900px;">
        <svg preserveAspectRatio xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="200 0 200 1500">
            <a id="region-A" xlink:title="Dakar <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/01">
            ...
            <a id="region-B" xlink:title="Diourbel <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/03">
            ...
            <a id="region-C" xlink:title="Fatick <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/09">
            ...
            <a id="region-D" xlink:title="Kaffrine <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/12">
            ...
            <a id="region-E" xlink:title="Kaolack <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/06">
            ...
            <a id="region-F" xlink:title="Kédougou <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/13">
            ...
            <a id="region-G" xlink:title="Kolda <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/10">
            ...
            <a id="region-H" xlink:title="Louga <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/08">
            ...
            <a id="region-I" xlink:title="Matam <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/11">
            ...
            <a id="region-J" xlink:title="Saint-Louis <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/04">
            ...
            <a id="region-K" xlink:title="Sédhiou <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/14">
            ...
            <a id="region-L" xlink:title="Tambacounda <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/05">
            ...
            <a id="region-M" xlink:title="Thiès <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/07">
            ...
            <a id="region-N" xlink:title="Ziguinchor <?php ?> distributreurs" xlink:href="<?php echo base_url();?>index.php/Welcome/region/02">
    ...
    <div class="map__list">
        <ul>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/01" id="list-A">Dakar</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/02" id="list-N">Ziguinchor</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/03" id="list-B">Diourbel</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/04" id="list-J">Saint-Louis</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/05" id="list-L">Tambacounda</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/06" id="list-E">Kaolack</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/07" id="list-M">Thiès</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/08" id="list-H">Louga</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/09" id="list-C">Fatick</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/10" id="list-G">Kolda</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/11" id="list-I">Matam</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/12" id="list-D">Kaffrine</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/13" id="list-F">Kédougou</a></li>
            <li><a href="<?php echo base_url();?>index.php/Welcome/region/14" id="list-K">Sédhiou</a></li>
        </ul>
    </div>
</div>
<script>
