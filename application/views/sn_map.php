...
<div class="map" id="map" style="height:500px;">
    <div class="map__image" style="height:900px;">
        <svg preserveAspectRatio xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="200 0 200 1500">
            <a id="region-A" xlink:title="Dakar <?php echo $promoteur01 ?> distributreur<?php if($promoteur01 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/01">
            ...
            <a id="region-B" xlink:title="Diourbel <?php echo $promoteur03 ?> distributreur<?php if($promoteur03 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/03">
            ...
            <a id="region-C" xlink:title="Fatick <?php echo $promoteur09 ?> distributreur <?php if($promoteur09 > 1){?>s<?php } ?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/09">
            ...
            <a id="region-D" xlink:title="Kaffrine <?php echo $promoteur12 ?> distributreur<?php if($promoteur12 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/12">
            ...
            <a id="region-E" xlink:title="Kaolack <?php echo $promoteur06 ?> distributreur<?php if($promoteur06 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/06">
            ...
            <a id="region-F" xlink:title="Kédougou <?php echo $promoteur13 ?> distributreur<?php if($promoteur13 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/13">
            ...
            <a id="region-G" xlink:title="Kolda <?php echo $promoteur10 ?> distributreur<?php if($promoteur10 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/10">
            ...
            <a id="region-H" xlink:title="Louga <?php echo $promoteur08 ?> distributreur<?php if($promoteur08 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/08">
            ...
            <a id="region-I" xlink:title="Matam <?php echo $promoteur11 ?> distributreur<?php if($promoteur11 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/11">
            ...
            <a id="region-J" xlink:title="Saint-Louis <?php echo $promoteur04 ?> distributreur<?php if($promoteur04 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/04">
            ...
            <a id="region-K" xlink:title="Sédhiou <?php echo $promoteur14 ?> distributreur<?php if($promoteur14 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/14">
            ...
            <a id="region-L" xlink:title="Tambacounda <?php echo $promoteur05 ?> distributreur<?php if($promoteur05 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/05">
            ...
            <a id="region-M" xlink:title="Thiès <?php echo $promoteur07 ?> distributreur<?php if($promoteur07 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/07">
            ...
            <a id="region-N" xlink:title="Ziguinchor <?php echo $promoteur02 ?> distributreur<?php if($promoteur02 > 1){?>s<?php }?>" xlink:href="<?php echo base_url();?>index.php/Welcome/region/02">
