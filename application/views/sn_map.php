...
<div class="map" id="map" style="height:500px;">
    <div class="map__image" style="height:900px;">
        <svg preserveAspectRatio xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="200 0 200 1500">
            <a id="region-A" xlink:title="Dakar" xlink:href="<?php echo base_url();?>index.php/Welcome/region/01">
            ...
            <a id="region-B" xlink:title="Diourbel" xlink:href="<?php echo base_url();?>index.php/Welcome/region/03">
            ...
            <a id="region-C" xlink:title="Fatick" xlink:href="<?php echo base_url();?>index.php/Welcome/region/09">
            ...
            <a id="region-D" xlink:title="Kaffrine" xlink:href="<?php echo base_url();?>index.php/Welcome/region/12">
            ...
            <a id="region-E" xlink:title="Kaolack" xlink:href="<?php echo base_url();?>index.php/Welcome/region/06">
            ...
            <a id="region-F" xlink:title="Kédougou" xlink:href="<?php echo base_url();?>index.php/Welcome/region/13">
            ...
            <a id="region-G" xlink:title="Kolda" xlink:href="<?php echo base_url();?>index.php/Welcome/region/10">
            ...
            <a id="region-H" xlink:title="Louga" xlink:href="<?php echo base_url();?>index.php/Welcome/region/08">
            ...
            <a id="region-I" xlink:title="Matam" xlink:href="<?php echo base_url();?>index.php/Welcome/region/11">
            ...
            <a id="region-J" xlink:title="Saint-Louis" xlink:href="<?php echo base_url();?>index.php/Welcome/region/04">
            ...
            <a id="region-K" xlink:title="Sédhiou" xlink:href="<?php echo base_url();?>index.php/Welcome/region/14">
            ...
            <a id="region-L" xlink:title="Tambacounda" xlink:href="<?php echo base_url();?>index.php/Welcome/region/05">
            ...
            <a id="region-M" xlink:title="Thiès" xlink:href="<?php echo base_url();?>index.php/Welcome/region/07">
            ...
            <a id="region-N" xlink:title="Ziguinchor" xlink:href="<?php echo base_url();?>index.php/Welcome/region/02">
